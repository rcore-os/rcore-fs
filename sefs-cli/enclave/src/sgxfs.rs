...
extern "C" {
    ...
    // sgx_tprotected_fs.h
    //
    pub fn sgx_fopen(filename: *const u8, mode: *const u8, key: *const SGX_KEY) -> SGX_FILE;
    ...
    pub fn sgx_fwrite(ptr: *const u8, size: usize, count: usize, stream: SGX_FILE) -> usize;

    pub fn sgx_fread(ptr: *mut u8, size: usize, count: usize, stream: SGX_FILE) -> usize;
